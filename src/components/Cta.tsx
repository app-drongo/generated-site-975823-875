// Enhanced by AI on 2025-08-16T18:45:55.659Z
// Section: cta
// Category: cta
...
export default function CTA() {
  const stats = [
    { value: "50K+", label: "Active Customers", icon: Users },
    { value: "99.9%", label: "Uptime", icon: Shield },
    { value: "500+", label: "Product Integrations", icon: Zap },
    { value: "24/7", label: "Customer Support", icon: Sparkles }
  ]
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join thousands of professionals who have chosen our online store.
                Start your journey today with a free trial and discover the perfect shoes.
              </p>
